...
<div class="circle">
   ...
   <div class="center">
      ...
      <p>感谢您使用<?php echo $web_title;?>(<a href="<?php echo $host;?>"><?php echo $host;?></a>)，您于 <?php echo date('Y-m-d H:i:s',$now_time);?> 提交了重置<span><?php echo $user_name;?></span>用户密码的申请。请点击下面的链接重设您的密码：
